...
#include "zstd_deps.h"
#define ZSTD_v1_5_2_STATIC_LINKING_ONLY   /* ZSTD_v1_5_2_customMem */
#include "../zstd.h"

typedef struct POOL_v1_5_2_ctx_s POOL_v1_5_2_ctx;

/*! POOL_v1_5_2_create() :
 *  Create a thread pool with at most `numThreads` threads.
 * `numThreads` must be at least 1.
 *  The maximum number of queued jobs before blocking is `queueSize`.
 * @return : POOL_v1_5_2_ctx pointer on success, else NULL.
*/
...
/*! POOL_v1_5_2_free() :
 *  Free a thread pool returned by POOL_v1_5_2_create().
 */
...
/*! POOL_v1_5_2_function :
 *  The function type that can be added to a thread pool.
 */
typedef void (*POOL_v1_5_2_function)(void*);
