...
- set build macro `ZSTD_v1_5_2_MULTITHREAD` (`-DZSTD_v1_5_2_MULTITHREAD` for `gcc`)
...
- `lib/ZSTD_errors.h` : translates `size_t` function results
                        into a `ZSTD_v1_5_2_ErrorCode`, for accurate error handling.

- `ZSTD_v1_5_2_STATIC_LINKING_ONLY` : if this macro is defined _before_ including `zstd.h`,
...
- `lib/legacy` : makes it possible to decompress legacy zstd formats, starting from `v0.1.0`.
        ...
        To enable this feature, define `ZSTD_v1_5_2_LEGACY_SUPPORT` during compilation.
        Specifying a number limits versions supported to that version onward.
        For example, `ZSTD_v1_5_2_LEGACY_SUPPORT=2` means : "support legacy formats >= v0.2.0".
        Conversely, `ZSTD_v1_5_2_LEGACY_SUPPORT=0` means "do __not__ support legacy formats".
        By default, this build macro is set as `ZSTD_v1_5_2_LEGACY_SUPPORT=5`.
...
- While invoking `make libzstd`, it's possible to define build macros
        `ZSTD_v1_5_2_LIB_COMPRESSION, ZSTD_v1_5_2_LIB_DECOMPRESSION`, `ZSTD_v1_5_2_LIB_DICTBUILDER`,
        and `ZSTD_v1_5_2_LIB_DEPRECATED` as `0` to forgo compilation of the
        corresponding features. This will also disable compilation of all
        dependencies (eg. `ZSTD_v1_5_2_LIB_COMPRESSION=0` will also disable
        dictBuilder).
...
- There are a number of options that can help minimize the binary size of
  ...
  `ZSTD_v1_5_2_LIB_COMPRESSION` etc.).

  The next step is to set `ZSTD_v1_5_2_LIB_MINIFY` to `1` when invoking `make`. This
  ...
  `ZSTD_v1_5_2_NO_INLINE`, which disables inlining, and `ZSTD_v1_5_2_STRIP_ERROR_STRINGS`,
  which removes the error messages that are otherwise returned by
  `ZSTD_v1_5_2_getErrorName` (implied by `ZSTD_v1_5_2_LIB_MINIFY`).
...
- While invoking `make libzstd`, the build macro `ZSTD_v1_5_2_LEGACY_MULTITHREADED_API=1`
...
- The build macro `ZSTD_v1_5_2_NO_UNUSED_FUNCTIONS` can be defined to hide the definitions of functions
...
- The build macro `ZSTD_v1_5_2_NO_INTRINSICS` can be defined to disable all explicit intrinsics.
  Compiler builtins are still used.

- The build macro `ZSTD_v1_5_2_DECODER_INTERNAL_BUFFER` can be set to control
  ...
  `ZSTD_v1_5_2_DCtx` decompression contexts,
