...
size_t ZSTD_v1_5_2_noCompressLiterals (void* dst, size_t dstCapacity, const void* src, size_t srcSize)
{
    ...
    ZSTD_v1_5_2_memcpy(ostart + flSize, src, srcSize);
...
{
    size_t const minGain = ZSTD_v1_5_2_minGain(srcSize, strategy);
    ...
    DEBUGLOG(5,"ZSTD_v1_5_2_compressLiterals (disableLiteralCompression=%i srcSize=%u)",
    ...
    if (disableLiteralCompression)
        return ZSTD_v1_5_2_noCompressLiterals(dst, dstCapacity, src, srcSize);
...
#   define COMPRESS_LITERALS_SIZE_MIN 63
    ...
    if (cLitSize==1) {
        ZSTD_v1_5_2_memcpy(nextHuf, prevHuf, sizeof(*prevHuf));
        return ZSTD_v1_5_2_compressRleLiteralsBlock(dst, dstCapacity, src, srcSize);
    }
