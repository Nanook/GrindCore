...
size_t ZSTD_v1_5_2_seekable_endFrame(ZSTD_v1_5_2_seekable_CStream* zcs, ZSTD_v1_5_2_outBuffer* output)
{
    ...
    /* end the frame */
    size_t ret = ZSTD_v1_5_2_endStream(zcs->cstream, output);
    ...
    ZSTD_v1_5_2_CCtx_reset(zcs->cstream, ZSTD_v1_5_2_reset_session_only);
...
size_t ZSTD_v1_5_2_seekable_compressStream(ZSTD_v1_5_2_seekable_CStream* zcs, ZSTD_v1_5_2_outBuffer* output, ZSTD_v1_5_2_inBuffer* input)
{
    ...
    if (inLen > 0) {
        ZSTD_v1_5_2_inBuffer inTmp = { inBase, inLen, 0 };
        size_t const prevOutPos = output->pos;

        size_t const ret = ZSTD_v1_5_2_compressStream(zcs->cstream, output, &inTmp);
...
size_t ZSTD_v1_5_2_seekable_writeSeekTable(ZSTD_v1_5_2_frameLog* fl, ZSTD_v1_5_2_outBuffer* output)
{
    ...
    CHECK_Z(ZSTD_stwrite32(fl, output, (U32)seekTableLen - ZSTD_v1_5_2_SKIPPABLEHEADERSIZE, 4));

    while (fl->seekTableIndex < fl->size) {
        unsigned long long const start = ZSTD_v1_5_2_SKIPPABLEHEADERSIZE + sizePerFrame * fl->seekTableIndex;
