#ifndef ZIP7_INC_SZ_LZMA2_v25_01_DEC_H
#define ZIP7_INC_SZ_LZMA2_v25_01_DEC_H
...
#include "external/sevenzip/lzma/LzmaEnc.h"
#include "external/sevenzip/lzma/LzmaDec.h"
#include "external/sevenzip/lzma/Lzma2Enc.h"
#include "external/sevenzip/lzma/Lzma2Dec.h"
...
#define SZ_Lzma2_v25_01_Dec_GetUnpackExtra(p)  ((p)->isExtraMode ? (p)->unpackSize : 0)
...
FUNCTIONEXPORT Byte FUNCTIONCALLINGCONVENCTION SZ_Lzma2_v25_01_Enc_WriteProperties(CLzma2EncHandle p);
