...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_DeflateInit2_(
...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_Deflate(PAL_ZStream* stream, int32_t flush)
{
    assert(stream != NULL);
...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_DeflateEnd(PAL_ZStream* stream)
{
    assert(stream != NULL);
...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_InflateInit2_(PAL_ZStream* stream, int32_t windowBits)
{
    assert(stream != NULL);
...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_Inflate(PAL_ZStream* stream, int32_t flush)
{
    assert(stream != NULL);
...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_InflateEnd(PAL_ZStream* stream)
{
    assert(stream != NULL);
...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_Compress(uint8_t *dest, uint32_t *destLen, const uint8_t *source, uint32_t sourceLen)
{
...
FUNCTIONEXPORT int32_t FUNCTIONCALLINGCONVENCTION DN8_ZLib_v1_3_1_Compress2(uint8_t* dest, uint32_t* destLen, const uint8_t* source, uint32_t sourceLen, int32_t level)
{
    uLongf uLongfDestLen = *destLen;
