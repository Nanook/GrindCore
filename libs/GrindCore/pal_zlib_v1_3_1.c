...
int32_t DN8_ZLib_v1_3_1_DeflateInit2_(
...
int32_t DN8_ZLib_v1_3_1_Deflate(PAL_ZStream* stream, int32_t flush)
{
    assert(stream != NULL);
...
int32_t DN8_ZLib_v1_3_1_DeflateEnd(PAL_ZStream* stream)
{
    assert(stream != NULL);
...
int32_t DN8_ZLib_v1_3_1_InflateInit2_(PAL_ZStream* stream, int32_t windowBits)
{
    assert(stream != NULL);
...
int32_t DN8_ZLib_v1_3_1_Inflate(PAL_ZStream* stream, int32_t flush)
{
    assert(stream != NULL);
...
int32_t DN8_ZLib_v1_3_1_InflateEnd(PAL_ZStream* stream)
{
    assert(stream != NULL);
...
uint32_t DN8_ZLib_v1_3_1_Crc32(uint32_t crc, uint8_t* buffer, int32_t len)
{
    assert(buffer != NULL);
...
int32_t DN8_ZLib_v1_3_1_Compress(uint8_t *dest, uint32_t *destLen, const uint8_t *source, uint32_t sourceLen)
{
...
int32_t DN8_ZLib_v1_3_1_Compress2(uint8_t* dest, uint32_t* destLen, const uint8_t* source, uint32_t sourceLen, int32_t level)
{
    uLongf uLongfDestLen = *destLen;
...
int32_t DN8_ZLib_v1_3_1_Compress3(uint8_t* dest, uint32_t* destLen, const uint8_t* source, uint32_t sourceLen, int32_t level, int32_t windowBits, int32_t memLevel, int32_t strategy)
{
    uLongf uLongfDestLen = *destLen;
...
int32_t DN8_ZLib_v1_3_1_Uncompress(uint8_t *dest, uint32_t *destLen, const uint8_t *source, uint32_t sourceLen)
{
    uLongf uLongfDestLen = *destLen;
...
int32_t DN8_ZLib_v1_3_1_Uncompress2(uint8_t* dest, uint32_t* destLen, const uint8_t* source, uint32_t* sourceLen)
{
    uLongf uLongfDestLen = *destLen;
...
int32_t DN8_ZLib_v1_3_1_Uncompress3(uint8_t* dest, uint32_t* destLen, const uint8_t* source, uint32_t* sourceLen, int32_t windowBits)
{
    uLongf uLongfDestLen = *destLen;
    uLong uLongSourceLen = *sourceLen;
    int32_t result = (int32_t)uncompress3(dest, &uLongfDestLen, source, &uLongSourceLen, windowBits);
    *destLen = (uint32_t)uLongfDestLen;
    *sourceLen = (uint32_t)uLongSourceLen;
    return result;
}
