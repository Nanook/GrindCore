...
static const Entry s_compressionNative[] =
{
    ...
    DllImportEntry(SZ_Lzma2_v24_07_Dec_Construct)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_FreeProbs)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_Free)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_AllocateProbs)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_Allocate)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_Init)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_DecodeToDic)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_DecodeToBuf)
    DllImportEntry(SZ_Lzma2_v24_07_Dec_Parse)
    DllImportEntry(SZ_Lzma2_v24_07_Decode)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_Construct)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_Normalize)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_Create)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_Destroy)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_SetProps)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_SetDataSize)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_WriteProperties)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_Encode2)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_EncodeMultiCall)
    DllImportEntry(SZ_Lzma2_v24_07_Enc_EncodeMultiCallPrepare)
    DllImportEntry(SZ_Lzma_v24_07_Dec_Construct)
    DllImportEntry(SZ_Lzma_v24_07_Dec_Init)
    DllImportEntry(SZ_Lzma_v24_07_Dec_AllocateProbs)
    DllImportEntry(SZ_Lzma_v24_07_Dec_FreeProbs)
    DllImportEntry(SZ_Lzma_v24_07_Dec_Allocate)
    DllImportEntry(SZ_Lzma_v24_07_Dec_Free)
    DllImportEntry(SZ_Lzma_v24_07_Dec_DecodeToDic)
    DllImportEntry(SZ_Lzma_v24_07_Dec_DecodeToBuf)
    DllImportEntry(SZ_Lzma_v24_07_Dec_LzmaDecode)
    DllImportEntry(SZ_Lzma_v24_07_EncProps_Init)
    DllImportEntry(SZ_Lzma_v24_07_EncProps_Normalize)
    DllImportEntry(SZ_Lzma_v24_07_EncProps_GetDictSize)
    DllImportEntry(SZ_Lzma_v24_07_Enc_Create)
    DllImportEntry(SZ_Lzma_v24_07_Enc_Destroy)
    DllImportEntry(SZ_Lzma_v24_07_Enc_SetProps)
    DllImportEntry(SZ_Lzma_v24_07_Enc_SetDataSize)
    DllImportEntry(SZ_Lzma_v24_07_Enc_WriteProperties)
    DllImportEntry(SZ_Lzma_v24_07_Enc_IsWriteEndMark)
    DllImportEntry(SZ_Lzma_v24_07_Enc_Encode)
    DllImportEntry(SZ_Lzma_v24_07_Enc_MemEncode)
    DllImportEntry(SZ_Lzma_v24_07_Enc_LzmaEncode)
    DllImportEntry(SZ_Lzma_v24_07_Enc_LzmaCodeMultiCall)
    DllImportEntry(SZ_Lzma_v24_07_Enc_LzmaCodeMultiCallPrepare)
    ...
    DllImportEntry(SZ_Lz4_v1_9_4_CompressHC)
    DllImportEntry(SZ_Lz4_v1_9_4_CompressHC_ExtState)
    DllImportEntry(SZ_Lz4_v1_9_4_CompressHC_DestSize)
