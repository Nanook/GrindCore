...
static const Entry s_compressionNative[] =
{
    ...
    DllImportEntry(SZ_ZStd_v1_5_7_SetNbWorkers)
    DllImportEntry(SZ_ZStd_v1_5_7_SetJobSize)
    DllImportEntry(SZ_ZStd_v1_5_7_CStreamInSize)
    DllImportEntry(SZ_ZStd_v1_5_7_CStreamOutSize)
    DllImportEntry(SZ_ZStd_v1_5_7_CompressBlockWithDict)
    DllImportEntry(SZ_ZStd_v1_5_7_DecompressBlockWithDict)
    DllImportEntry(SZ_ZStd_v1_5_7_SetCompressionDict)
    DllImportEntry(SZ_ZStd_v1_5_7_SetDecompressionDict)
